...
/// </summary>
/// <remarks>
/// Deliberate duplicate of <c>SportsClubEventManager.Api.HealthChecks.HealthCheckResponseWriter</c>.
/// This is presentation logic local to each host (nobody deserializes one host's health
/// response from the other), not a cross-host contract, so it does not belong in the
/// <c>Shared</c> project (see design doc "Technology Choices").
/// </remarks>
