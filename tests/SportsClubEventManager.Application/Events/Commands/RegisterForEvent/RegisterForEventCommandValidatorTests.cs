...
/// <summary>
/// Tests for RegisterForEventCommandValidator to verify command validation logic.
/// </summary>
public class RegisterForEventCommandValidatorTests
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RegisterForEventCommandValidatorTests"/> class.
    /// </summary>
    public RegisterForEventCommandValidatorTests()
    {
    }

    private readonly RegisterForEventCommandValidator _validator = new();

    /// <summary>
    /// Tests that verify successful validation scenarios.
    /// </summary>
    public sealed class WhenCommandIsValid : RegisterForEventCommandValidatorTests
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class WhenEventIdIsInvalid : RegisterForEventCommandValidatorTests
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class WhenUserIdIsInvalid : RegisterForEventCommandValidatorTests
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class WhenMultipleFieldsAreInvalid : RegisterForEventCommandValidatorTests
    {
        /// <summary>
