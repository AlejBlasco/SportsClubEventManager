...
- Procedimiento operativo completo (comandos exactos, troubleshooting) en [`docs/deployment/homelab-deployment.md`](../../deployment/homelab-deployment.md) y [`infrastructure/deploy/DEPLOYMENT_RUNBOOK.md`](../../../infrastructure/deploy/DEPLOYMENT_RUNBOOK.md).
