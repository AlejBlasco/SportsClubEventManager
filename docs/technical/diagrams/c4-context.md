...
- Los tres tipos de `Person` reflejan los tres niveles de acceso reales de la aplicación: anónimo (solo calendario público), `User` (autoservicio) y `Administrator` (gestión completa) — ver [`docs/technical/US-28-autorizacion-basada-en-roles.md`](../US-28-autorizacion-basada-en-roles.md).
